...
export class Renderer {
    ...
    _columns() {
        return this._fontId == 1 ? 39 : 40;
    }

    _rows() {
        return this._fontId == 1 ? 25 : 24;
    }
    ...
    drawText(c, x, y, r, g, b) {
        const i = Math.floor(y / this._fontConfig[this._fontId][1]) * this._columns() + Math.floor(x / this._fontConfig[this._fontId][0]);
